...
public class GameBoard {
    ...
    public void openSurroundedCells(CellPosition cellPosition) {
        ...
        calculateSurroundedPositions(cellPosition, getRowSize(), getColSize()).forEach(
            this::openSurroundedCells);
    }
    ...
    private List<CellPosition> calculateSurroundedPositions(CellPosition cellPosition, int rowSize,
        ...
        return RelativePosition.SURROUNDED_POSITIONS.stream()
            .filter(cellPosition::canCalculatePositionBy).map(cellPosition::calculatePositionBy)
